...
<div class="container mx-auto py-12 pt-24 px-4">
    <!-- Profil -->
    <h2 class="text-3xl font-bold text-blue-700 mb-6">Profil</h2>
    ...
    <!-- Sejarah -->
    <h2 class="text-2xl font-bold text-blue-700 mt-8 mb-4">Sejarah</h2>
    <p class="text-gray-700 mb-8">
    ...
    <!-- Struktur Organisasi -->
    <h2 class="text-2xl font-bold text-blue-700 mt-8 mb-4">Struktur Organisasi</h2>
    <p class="text-gray-700 mb-8">
    ...
    <!-- Visi & Misi -->
    <h2 class="text-2xl font-bold text-blue-700 mt-8 mb-4">Visi & Misi</h2>
